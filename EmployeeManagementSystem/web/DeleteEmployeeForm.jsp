<%-- 
    ...
    Created on : 4 Jul, 2023, 11:28:53 AM
    Author     : yaswa
--%>
...
<html>
    ...
    <body>
        <form action="DeleteEmployee.jsp" method="post" onsubmit="confirm('Record is deleted');">
            <h3>Following data is going to be deleted</h3>
            <table>
        <%
